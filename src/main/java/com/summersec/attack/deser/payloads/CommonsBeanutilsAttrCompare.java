...
//        attrNS1.setValues(coreDocument,"1","1","1");
        ...
        Class attrNS1CLASS = Class.forName("com.sun.org.apache.xerces.internal.dom.AttrNSImpl");
        Method setOwnerDocumentMETHOD = attrNS1CLASS.getSuperclass().getDeclaredMethod("setOwnerDocument",CoreDocumentImpl.class);
        AttrNSImpl attrNS1 = (AttrNSImpl) attrNS1CLASS.newInstance();
        setOwnerDocumentMETHOD.setAccessible(true);
        setOwnerDocumentMETHOD.invoke(attrNS1,coreDocument);
